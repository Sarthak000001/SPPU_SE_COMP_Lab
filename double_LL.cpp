...
while(flag){
	...
	int c; cout << "Enter your Choice : " << endl; cin >> c;
	if(c==0){
		l1.display();
		char x;cout << "Do you want to continue (y/n): " << endl; cin >> x;
				if(x=='y' || x=='Y'){
					flag = true;
				}
				else{
		...
		cout << "Enter the value you want to Insert : " << endl; int val; cin >> val;
		l1.insert_start(val);
		char x;cout << "Do you want to continue (y/n): " << endl; cin >> x;
		if(x=='y' || x=='Y'){
			flag = true;
		...
		int val; cout << "Enter the value you want to Insert : " << endl; cin >> val;
		int p; cout << "Enter the Position : " << endl; cin >> p;
		...
		cout << "Enter the Position : " << endl; int p; cin >> p;
